...
Here is an example demonstrating the sensitivity of surface air temperature (SAT) standard deviation to sampling rate. The data are from the [UTSC weather station](https://weather.utsc.utoronto.ca/data/).
