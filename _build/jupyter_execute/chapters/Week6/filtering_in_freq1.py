...
# $$
# 
# We can approximate the variance of $y(t)$ as $\sum_{k=1}^{N/2}\frac{C_k^2}{2}$ such that,
# 
# $$
...
# Let's check that the variance of the ENSO time series is roughly approximated by $\sum_{k=1}^{N/2}\frac{C_k^2}{2}$
