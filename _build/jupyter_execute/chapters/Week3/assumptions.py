...
# 
# The test we will use is called the [Goldfeld-Quandt test](https://www.statisticshowto.com/goldfeld-quandt-test/), which in essence tests whether or not the variances of the residuals for two different segments of your data are significantly different from each other using an $F$-statistic.
# 
